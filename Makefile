...
TARGETS := doTest doTest2 showHandler libULT.a alarmHelper parseUcontext ourThreadTests
...
ULT_SRC :=  ULT.c readyList.c interrupt.c
MOREH := cfuncproto.h
MOREO :=
...
ULT: ULT.o libULT.a readyList.o
	gcc $(CFLAGS) -o $@ ULT.c readyList.c
...
ourThreadTests.o: ourThreadTests.c interrupt.h ULT.h $(MOREH)
	gcc -c $(CFLAGS) -o $@ ourThreadTests.c
